...
class Student1:
    def __init__(self,root):
        ...
        #First IMG
        img=Image.open(r"C:\Users\kiran\Desktop\face Recognition System\college_images\student1.jpg")
        ...
        #Second IMG
        img1=Image.open(r"C:\Users\kiran\Desktop\face Recognition System\college_images\student.png")
        ...
        #left label frame
        Left_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Subject Attendance Details",font=("times new roman",12,"bold"))
        ...
        # Currunt Frame
        current_course_frame=LabelFrame(Left_frame,bd=2,bg="white",relief=RIDGE,text="Subject Attendance Information",font=("times new roman",12,"bold"))
        ...
        dep_combo["values"]=("Select Medium","English","Semi English","Marathi")
        dep_combo.current(0)
        dep_combo.grid(row=0,column=1,padx=2,pady=10,sticky=W)
       
        # Course
        course_label=Label(current_course_frame,text="Standard",font=("times new roman",12,"bold"),bg="white")
        ...
        # Semester
        semester_label=Label(current_course_frame,text="Term",font=("times new roman",12,"bold"),bg="white")
        ...
        semester_combo["values"]=("Term","Mid-term","End-term")
        ...
        class_student_frame=LabelFrame(Left_frame,bd=2,bg="white",relief=RIDGE,text="Subject Attendance",font=("times new roman",12,"bold"))
        ...
        #DOB
        #dob_label=Label(class_student_frame,text="Subject",font=("times new roman",12,"bold"),bg="white")
        ...
        subject_label=Label(class_student_frame,text="SubjectA",font=("times new roman",12,"bold"),bg="white")
        subject_label.grid(row=2,column=2,padx=10,sticky=W)

        subject_combo=ttk.Combobox(class_student_frame,textvariable=self.var_subject,font=("times new roman",12,"bold"),state="readonly",width=11)
        subject_combo["values"]=("Select Subject","Marathi","Hindi","English","Mathematics","History","Social Science")
        subject_combo.current(0)
        subject_combo.grid(row=2,column=3,padx=0,pady=5,sticky=W)
       ...
       #phone no
        ...
        self.student_table=ttk.Treeview(table_frame,columns=("dep","course","year","sem","id","name","div","roll","gender","subject","email","phone","address","teacher","photo"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
  ...
  #  =======================function description========================    
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                my_cursor.execute("insert into subattendance values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)",(
    ...
    def fetch_data(self):
        conn=mysql.connector.connect(host="localhost",username="root",password="root",database="face_recognizer")
        my_cursor=conn.cursor()  
        my_cursor.execute("select * from subattendance")
        ...
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                if Upadate>0:
                    conn=mysql.connector.connect(host="localhost",username="root",password="root",database="face_recognizer")
                    my_cursor=conn.cursor() 
                    my_cursor.execute("update subattendance set Dep=%s,Course=%s,Year=%s,Semester=%s,Name=%s,Division=%s,Roll=%s,Gender=%s,Subject=%s,Email=%s,Phone=%s,Address=%s,Teacher=%s,PhotoSample=%s where Student_id=%s",(
        ...
        if self.var_std_id.get()=="":
            ...
            try:
                ...
                if delete>0:
                    conn=mysql.connector.connect(host="localhost",username="root",password="root",database="face_recognizer")
                    my_cursor=conn.cursor() 
                    sql="delete from subattendance where Student_id=%s"
    ...
    def search_data(self):
        if self.var_combo_search.get()=="" or self.var_search.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host="localhost",username="root",password="root",database="face_recognizer")
                my_cursor=conn.cursor()
                my_cursor.execute("select * from subattendance where " +str(self.var_combo_search.get())+" LIKE '%"+str(self.var_search.get())+"%'")
